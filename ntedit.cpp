...
static const char USAGE_MESSAGE[] = PROGRAM
    ...
    "\n"
    "	-p, minimum k-mer coverage threshold for a base to be considered confident\n"
    "			and minimum median k-mer coverage threshold within the subset for a base to be considered "
    "confident\n"
    "			when using a counting Bloom filter [default=minimum of counting Bloom filter "
    "counts, cannot be larger than 255]\n"
    "	-q, maximum k-mer coverage threshold for a base to be considered confident\n"
